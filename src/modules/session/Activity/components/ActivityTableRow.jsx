...
import ActivityTableInnerRow from "./Assesment/ActivityTableInnerRow";
import classNames from "classnames";
import LibraryTableInnerRow from "./Library/LibraryTableInnerRow";
import VideoTableInnerRow from "./Lcms-video/VideoTableInnerRow";
import WorksheetTableInnerRow from "./Worksheet-lcms/WorksheetTableInnerRow";
    ...
    >
      ...
      <Collapse isOpen={isOpen} className={styles.collapseContent}>
        {isLibrary
          ...
          : isWorksheet
          ? item?.activity_level_has_topic_nodes?.map((x, index) =>
              x?.activity_pdfs?.map((extra, index) => {
                return (
                  <WorksheetTableInnerRow
                    key={index}
                    styles={styles}
                    extra={extra}
                    handleSelected={handleSelected}
