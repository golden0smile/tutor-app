...
import ModalViewReport from "../components/Modals/ModalViewReport";
import ModalForStudentDetails from "../components/Modals/ModalforStudentDetails";
...
import ReScheduleEditLessonHeader from "../components/EditLesson/ReScheduleEditLessonHeader";
import ReSchedulePastSessionItem from "../components/EditLesson/ReSchedulePastSessionItem";
import ReScheduleEditPlan from "../components/EditLesson/ReScheduleEditPlan";
...
const EditLessonPlan = () => {
  ...
  const updateLessonDetailsEvent = () => {
    let values = {
      ...
      fk_sest_key: locationParams?.sessionId,
      fk_student_key: locationParams?.studentId,
    };
