...
import { handleEndDuration } from "modules/session/utils/getDuration";
  ...
  const countData = useMemo(() => {
    return [
      ...
      },
      {
        ...
        amount: "SGD " + (count?.pendingPayment || 0),
        redirectionLink: routesConstants.TIME_SHEETS_PAGE,
        footerTitle:
          // (count?.totalPaidSessionsCountInWeek || 0) + " All paid this week",

          count?.pendingPaymentCountInWeek !== 0
            ? (count?.pendingPaymentCountInWeek || 0) + " this week"
            : " All paid this week",
        color: "#F7D9CA",
      },
      {
        ...
        footerTitle:
          count?.totalUpComingSessionsInHourCount > 0
            ? "1 upcoming in " +
              // (count?.totalUpComingSessionsInHourCount || 0) +
              // " hour"
              handleEndDuration(count?.totalUpComingSessionsInHourCount)
